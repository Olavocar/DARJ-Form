...
try {
    ...
    $mail->Password   = 'lkhbiirayxvcnrod';                               //SMTP password
	...
	$body = DARJ - Mensagem Cadastro através Site:<br>Nome: $_POST['nome']<br>Email: $_POST['email']<br>Telefone: $_POST['tel']<br>Mensagem: $_POST['mensagem']  
